...
(function () {
  ...
  var I18N = {
    fr: {
      ...
      "talon.tagline": "Solitaire Klondike & Spider, sans publicité",
      "talon.desc": "Un solitaire sans aucune publicité et entièrement hors ligne. Chaque donne a été résolue à l’avance : elle est toujours gagnable, et affiche son « par », le nombre de coups de la meilleure solution connue. À vous de faire mieux.",
      "talon.c1": "Zéro publicité",
      "talon.c2": "Donnes toujours gagnables",
      "talon.c3": "Un par à battre",
      "talon.c4": "Donne du jour",
      "talon.c5": "100 % hors-ligne",
      "talon.c6": "Jeu à quatre couleurs",
    ...
    en: {
      ...
      "talon.tagline": "Klondike & Spider solitaire, ad-free",
      "talon.desc": "A solitaire with no ads at all, fully offline. Every deal was solved in advance: it is always winnable, and it shows its par — the move count of the best known solution. Your turn to do better.",
      "talon.c1": "Zero ads",
      "talon.c2": "Always winnable deals",
      "talon.c3": "A par to beat",
      "talon.c4": "Daily deal",
      "talon.c5": "100% offline",
      "talon.c6": "Four-colour deck",
    ...
    ja: {
      ...
      "binero.c5": "100% オフライン",
      "binero.c6": "ヒント & ヘルプ",
      "talon.tagline": "ソリティア：クロンダイク & スパイダー、広告なし",
      "talon.desc": "広告が一切なく、完全オフラインで遊べるソリティア。すべての配りはあらかじめ解かれており、必ずクリアできます。既知の最善手順の手数「パー」も表示。あなたはそれを超えられますか。",
      "talon.c1": "広告ゼロ",
      "talon.c2": "必ず解ける配り",
      "talon.c3": "パーに挑戦",
      "talon.c4": "デイリーの配り",
    ...
    ko: {
      ...
      "binero.c5": "100% 오프라인",
      "binero.c6": "힌트 & 도움말",
      "talon.tagline": "솔리테어 클론다이크 & 스파이더, 광고 없음",
      "talon.desc": "광고가 전혀 없고 완전히 오프라인으로 즐기는 솔리테어. 모든 딜은 미리 풀어 두어 항상 클리어할 수 있으며, 알려진 최선 해법의 수인 '파'를 함께 표시합니다. 그보다 더 잘해 보세요.",
      "talon.c1": "광고 제로",
      "talon.c2": "항상 풀리는 딜",
      "talon.c3": "넘어야 할 파",
      "talon.c4": "오늘의 딜",
    ...
    es: {
      ...
      "talon.tagline": "Solitario Klondike y Spider, sin anuncios",
      "talon.desc": "Un solitario sin ningún anuncio y totalmente sin conexión. Cada reparto se resolvió de antemano: siempre tiene solución y muestra su «par», el número de jugadas de la mejor solución conocida. Te toca superarlo.",
      "talon.c1": "Cero anuncios",
      "talon.c2": "Repartos siempre ganables",
      "talon.c3": "Un par que batir",
      "talon.c4": "Reparto diario",
      "talon.c5": "100 % sin conexión",
      "talon.c6": "Baraja de cuatro colores",
    ...
    de: {
      ...
      "talon.tagline": "Solitär Klondike & Spider, ohne Werbung",
      "talon.desc": "Ein Solitaire ganz ohne Werbung und vollständig offline. Jede Verteilung wurde vorab gelöst: Sie ist immer gewinnbar und zeigt ihr „Par“ — die Zugzahl der besten bekannten Lösung. Machen Sie es besser.",
      "talon.c1": "Null Werbung",
      "talon.c2": "Immer lösbare Verteilungen",
      "talon.c3": "Ein Par zum Schlagen",
      "talon.c4": "Tägliche Verteilung",
      "talon.c5": "100 % offline",
      "talon.c6": "Vierfarbiges Blatt",
