...
(function () {
  ...
  var I18N = {
    fr: {
      ...
      "zenkuro.tagline": "Le kakuro, en douceur",
      "zenkuro.desc": "Un jeu de kakuro pastel et zen. Des grilles infinies à solution unique garantie, une mascotte adorable qui t'accompagne, indices et mode crayon — en français comme en anglais.",
      "zenkuro.c1": "Grilles infinies",
      "zenkuro.c2": "Solution unique",
      "zenkuro.c3": "Indices & mode crayon",
      "zenkuro.c4": "Mascotte Momo",
      "zenkuro.c5": "Chrono & records",
      "zenkuro.c6": "100 % hors-ligne",
    ...
    en: {
      ...
      "glyphe.c6": "No ads",
      "zenkuro.tagline": "Kakuro, made gentle",
      "zenkuro.desc": "A pastel, zen kakuro game. Endless grids with a guaranteed unique solution, an adorable mascot by your side, hints and pencil mode — in both English and French.",
      "zenkuro.c1": "Endless grids",
      "zenkuro.c2": "Unique solution",
      "zenkuro.c3": "Hints & pencil mode",
      "zenkuro.c4": "Momo the mascot",
      "zenkuro.c5": "Timer & records",
      "zenkuro.c6": "100% offline",
