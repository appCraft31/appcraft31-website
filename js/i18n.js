...
(function () {
  ...
  var I18N = {
    fr: {
      ...
      "keeply.desc": "Balayez, gardez, libérez. Keeply transforme des milliers de photos en missions courtes et rassurantes — doublons, similaires, captures d'écran, vidéos lourdes — vos photos restent 100 % sur l'appareil.",
      ...
      "solitaire.tagline": "Klondike & Spider, sans publicité",
      "solitaire.desc": "Un solitaire sans aucune publicité et entièrement hors ligne. Chaque donne a été résolue à l’avance : elle est toujours gagnable, et affiche son « par », le nombre de coups de la meilleure solution connue. À vous de faire mieux.",
      "solitaire.c1": "Zéro publicité",
      "solitaire.c2": "Donnes toujours gagnables",
      "solitaire.c3": "Un par à battre",
      "solitaire.c4": "Donne du jour",
      "solitaire.c5": "100 % hors-ligne",
      "solitaire.c6": "Jeu à quatre couleurs",
      ...
      "tinta.tagline": "Puzzle logique couleur",
      "tinta.desc": "Un puzzle de déduction pure : 300 grilles logiques vérifiées, des indices malins, zéro hasard. Chaque grille cache un coloriage secret à solution unique — on ne devine jamais, on déduit.",
      "tinta.c1": "Zéro hasard",
      "tinta.c2": "300 niveaux",
      "tinta.c3": "Indices malins",
      "tinta.c4": "Mode expert",
      "tinta.c5": "Symboles accessibles",
      "tinta.c6": "Clair & sombre",
      "contree.tagline": "La belote contrée, toutes les règles",
      "contree.desc": "La belote contrée sans compromis : enchères jusqu'au capot, contre et surcontre, belote et rebelote, dix de der. En solo contre trois IA qui comptent les cartes, ou à quatre en ligne via Game Center.",
      "contree.c1": "Toutes les règles",
      "contree.c2": "Contre & surcontre",
      "contree.c3": "3 IA, 3 niveaux",
      "contree.c4": "Multijoueur Game Center",
      "contree.c5": "Solo hors-ligne",
      "contree.c6": "VoiceOver",
      ...
      "meliz.play_online": "Jouer en ligne",
    ...
    en: {
      ...
      "keeply.desc": "Swipe, keep, free up space. Keeply turns thousands of photos into short, reassuring missions — duplicates, similar shots, screenshots, heavy videos — your photos stay 100% on-device.",
      ...
      "solitaire.tagline": "Klondike & Spider, ad-free",
      "solitaire.desc": "A solitaire with no ads at all, fully offline. Every deal was solved in advance: it is always winnable, and it shows its par — the move count of the best known solution. Your turn to do better.",
      "solitaire.c1": "Zero ads",
      "solitaire.c2": "Always winnable deals",
      "solitaire.c3": "A par to beat",
      "solitaire.c4": "Daily deal",
      "solitaire.c5": "100% offline",
      "solitaire.c6": "Four-colour deck",
      ...
      "tinta.tagline": "Colour logic puzzle",
      "tinta.desc": "A pure-deduction puzzle: 300 verified logic grids, smart hints, zero guessing. Each grid hides a secret colouring with a unique solution — you never guess, you deduce.",
      "tinta.c1": "Zero guessing",
      "tinta.c2": "300 levels",
      "tinta.c3": "Smart hints",
      "tinta.c4": "Expert mode",
      "tinta.c5": "Accessible symbols",
      "tinta.c6": "Light & dark",
      "contree.tagline": "Belote Contrée, every rule",
      "contree.desc": "Belote Contrée with no compromise: bidding up to capot, contre and surcontre, belote and rebelote, dix de der. Play solo against three card-counting AIs, or four-player online through Game Center.",
      "contree.c1": "Every rule",
      "contree.c2": "Contre & surcontre",
      "contree.c3": "3 AIs, 3 levels",
      "contree.c4": "Game Center multiplayer",
      "contree.c5": "Offline solo",
      "contree.c6": "VoiceOver",
    ...
    ja: {
      ...
      "keeply.desc": "スワイプして、残して、容量を解放。Keeplyは何千枚もの写真を短く安心できるミッションに変えます——重複、似た写真、スクリーンショット、重い動画。写真は100%デバイス上に残ります。",
      ...
      "binero.c5": "100% オフライン",
      "binero.c6": "ヒント & ヘルプ",
      "solitaire.tagline": "クロンダイク & スパイダー、広告なし",
      "solitaire.desc": "広告が一切なく、完全オフラインで遊べるソリティア。すべての配りはあらかじめ解かれており、必ずクリアできます。既知の最善手順の手数「パー」も表示。あなたはそれを超えられますか。",
      "solitaire.c1": "広告ゼロ",
      "solitaire.c2": "必ず解ける配り",
      "solitaire.c3": "パーに挑戦",
      "solitaire.c4": "デイリーの配り",
      "solitaire.c5": "100% オフライン",
      "solitaire.c6": "4色デッキ",
    ...
    ko: {
      ...
      "keeply.desc": "스와이프하고, 보관하고, 용량을 확보하세요. Keeply는 수천 장의 사진을 짧고 안심되는 미션으로 바꿔줍니다 — 중복 사진, 유사 사진, 스크린샷, 용량이 큰 동영상. 사진은 100% 기기에만 저장됩니다.",
      "keeply.c1": "안내형 미션",
      "keeply.c2": "안전한 휴지통",
      "keeply.c3": "중복 & 유사 사진",
      "keeply.c4": "용량 큰 동영상",
      ...
      "binero.c5": "100% 오프라인",
      "binero.c6": "힌트 & 도움말",
      "solitaire.tagline": "클론다이크 & 스파이더, 광고 없음",
      "solitaire.desc": "광고가 전혀 없고 완전히 오프라인으로 즐기는 솔리테어. 모든 딜은 미리 풀어 두어 항상 클리어할 수 있으며, 알려진 최선 해법의 수인 '파'를 함께 표시합니다. 그보다 더 잘해 보세요.",
      "solitaire.c1": "광고 제로",
      "solitaire.c2": "항상 풀리는 딜",
      "solitaire.c3": "넘어야 할 파",
      "solitaire.c4": "오늘의 딜",
      "solitaire.c5": "100% 오프라인",
      "solitaire.c6": "4색 카드",
    ...
    es: {
      ...
      "keeply.desc": "Desliza, conserva, libera espacio. Keeply convierte miles de fotos en misiones cortas y tranquilizadoras: duplicados, similares, capturas de pantalla, vídeos pesados. Tus fotos permanecen al 100 % en tu dispositivo.",
      ...
      "solitaire.tagline": "Klondike y Spider, sin anuncios",
      "solitaire.desc": "Un solitario sin ningún anuncio y totalmente sin conexión. Cada reparto se resolvió de antemano: siempre tiene solución y muestra su «par», el número de jugadas de la mejor solución conocida. Te toca superarlo.",
      "solitaire.c1": "Cero anuncios",
      "solitaire.c2": "Repartos siempre ganables",
      "solitaire.c3": "Un par que batir",
      "solitaire.c4": "Reparto diario",
      "solitaire.c5": "100 % sin conexión",
      "solitaire.c6": "Baraja de cuatro colores",
      ...
      "meliz.play_online": "Jugar en línea",
    ...
    de: {
      ...
      "keeply.desc": "Wischen, behalten, Platz freimachen. Keeply verwandelt Tausende Fotos in kurze, beruhigende Missionen — Duplikate, ähnliche Fotos, Screenshots, große Videos. Ihre Fotos bleiben zu 100 % auf dem Gerät.",
      ...
      "solitaire.tagline": "Klondike & Spider, ohne Werbung",
      "solitaire.desc": "Ein Solitaire ganz ohne Werbung und vollständig offline. Jede Verteilung wurde vorab gelöst: Sie ist immer gewinnbar und zeigt ihr „Par“ — die Zugzahl der besten bekannten Lösung. Machen Sie es besser.",
      "solitaire.c1": "Null Werbung",
      "solitaire.c2": "Immer lösbare Verteilungen",
      "solitaire.c3": "Ein Par zum Schlagen",
      "solitaire.c4": "Tägliche Verteilung",
      "solitaire.c5": "100 % offline",
      "solitaire.c6": "Vierfarbiges Blatt",
      ...
      "meliz.play_online": "Online spielen",
